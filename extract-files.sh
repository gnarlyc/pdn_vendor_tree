...
adb pull /system/lib/libskia.so ../../../vendor/$VENDOR/$DEVICE/proprietary
adb pull /system/lib/libskiagl.so ../../../vendor/$VENDOR/$DEVICE/proprietary
...
PRODUCT_COPY_FILES := \\
    ...
    vendor/pandigital/__DEVICE__/proprietary/libskia.so:obj/lib/libskia.so \\
    vendor/pandigital/__DEVICE__/proprietary/libskiagl.so:obj/lib/libskiagl.so
